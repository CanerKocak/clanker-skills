...
**When to use:** After completing deep context analysis (Phase 4), apply this to all HIGH-priority review changes.
...
## Vulnerability Candidate Template

Generate this for each candidate. This is adversarial evidence, not an
adjudicated finding:

```markdown
## Candidate: [Title]

**Severity:** UNASSIGNED pending Phase 5.5 finding promotion
...
**Next:** Run every candidate through the Phase 5.5 finding-promotion gate in
[methodology.md](methodology.md#phase-55-handoff-finding-promotion). Only
accepted `LIVE` or justified `RESIDUAL` findings enter the severity report; keep
`POLICY`, `PARTIAL`, and declined candidates in their separate dispositions.
